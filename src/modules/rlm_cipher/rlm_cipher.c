...
extern xlat_arg_parser_t cipher_rsa_encrypt_xlat_arg;
xlat_arg_parser_t cipher_rsa_encrypt_xlat_arg = {
...
extern xlat_arg_parser_t cipher_rsa_sign_xlat_arg;
xlat_arg_parser_t cipher_rsa_sign_xlat_arg = {
	.required = true, .concat = true, .single = false, .variadic = false, .type = FR_TYPE_STRING,
	.func = NULL, .uctx = NULL
};
...
extern xlat_arg_parser_t cipher_rsa_decrypt_xlat_arg;
xlat_arg_parser_t cipher_rsa_decrypt_xlat_arg = {
...
extern xlat_arg_parser_t cipher_rsa_verify_xlat_arg[];
xlat_arg_parser_t cipher_rsa_verify_xlat_arg[] = {
